...
class FetchShared extends StatefulWidget {
  ...
  @override
  State createState() => _FetchSharedState();
}

class _FetchSharedState extends State<FetchShared>
  ...
  Future<void> fetchSharedPosts(List<dynamic> favoritePostIds) async {
    try {
      ...
      print('Error obteniendo posts compartidos: $e');
      setState(() {
        isLoading = false;
      });
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tus Compartidos'),
      ),
