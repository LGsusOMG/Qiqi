...
class FetchFavoritos extends StatefulWidget {
  ...
  @override
  State createState() => _FetchFavoritosState();
}

class _FetchFavoritosState extends State<FetchFavoritos>
  ...
  @override
  void dispose() {
    _likeAnimationController.dispose(); // Liberar recursos del controlador
    _favoritoAnimationController.dispose(); // Liberar recursos del controlador
