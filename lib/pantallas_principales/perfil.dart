...
import 'package:xtats001/pantallas/configuracionscreen.dart';
import 'package:xtats001/pantallas/postscreen.dart';

class Perfil extends StatefulWidget {
  const Perfil({super.key});

  @override
  State createState() => _PerfilState();
}
...
class _PerfilState extends State<Perfil> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(userData?['username'] ?? 'Perfil'),
        backgroundColor: const Color.fromARGB(255, 126, 73, 216),
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const PublicarScreen()),
              );
            },
          ),
          IconButton(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              _buildStoryIcon('Historia 1'),
                              const SizedBox(width: 10),
                              _buildStoryIcon('Historia 2'),
                            ],
                          ),
                        ),*/
                        const Divider(),
  ...
  /*Widget _buildStoryIcon(String storyTitle) {
    return GestureDetector(
      onTap: () {
